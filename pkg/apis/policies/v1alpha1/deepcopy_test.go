...
var samplePolicy = TrustedContainerPolicy{
	ObjectMeta: metav1.ObjectMeta{
		Name:      "foo",
		Namespace: "default",
	}}

var samplePolicySpec = TrustedContainerPolicySpec{
	Severity:                        "high",
...
var items = []TrustedContainerPolicy{}
...
func TestTrustedContainerPolicyDeepCopyInto(t *testing.T) {
	policy2 := TrustedContainerPolicy{}
	samplePolicy.DeepCopyInto(&policy2)
	assert.True(t, reflect.DeepEqual(samplePolicy, policy2))
}

func TestTrustedContainerPolicyDeepCopy(t *testing.T) {
	policy := TrustedContainerPolicy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "foo",
			Namespace: "default",
		}}
...
func TestTrustedContainerPolicySpecDeepCopyInto(t *testing.T) {
	policySpec2 := TrustedContainerPolicySpec{}
	samplePolicySpec.DeepCopyInto(&policySpec2)
	assert.True(t, reflect.DeepEqual(samplePolicySpec, policySpec2))
}

func TestTrustedContainerPolicySpecDeepCopy(t *testing.T) {
	policySpec2 := samplePolicySpec.DeepCopy()
	assert.True(t, reflect.DeepEqual(samplePolicySpec, *policySpec2))
}

func TestTrustedContainerPolicyListDeepCopy(t *testing.T) {
	items = append(items, samplePolicy)
	samplePolicyList := TrustedContainerPolicyList{
		TypeMeta: typeMeta,
		ListMeta: listMeta,
		Items:    items,
	}
...
func TestTrustedContainerPolicyListDeepCopyInto(t *testing.T) {
	items = append(items, samplePolicy)
	samplePolicyList := TrustedContainerPolicyList{
		TypeMeta: typeMeta,
		ListMeta: listMeta,
	...
	samplePolicyList2 := TrustedContainerPolicyList{}
	samplePolicyList.DeepCopyInto(&samplePolicyList2)
	assert.True(t, reflect.DeepEqual(samplePolicyList, samplePolicyList2))
}

func TestTrustedContainerPolicyStatusDeepCopy(t *testing.T) {
	...
	samplePolicyStatus := TrustedContainerPolicyStatus{
...
func TestTrustedContainerPolicyStatusDeepCopyInto(t *testing.T) {
	var compliantDetail = map[string][]string{}
	var compliantDetails = map[string]map[string][]string{}
	details := []string{}
	...
	var samplePolicyStatus2 TrustedContainerPolicyStatus
